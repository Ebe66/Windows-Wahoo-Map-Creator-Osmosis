...
filtered_tags = 'access=private \
    aeroway=aerodrome =airport =gate =helipad =runway =taxiway \
    ...
    leisure=nature_reserve =park =picnic_table \
    ...
    surface= \
    tourism=alpine_hut =attraction =hostel =hotel =information =museum =picnic_site =viewpoint =zoo \
    tracktype= \
    tunnel= \
    waterway=canal =drain =stream =river =riverbank \
    wood=deciduous'
